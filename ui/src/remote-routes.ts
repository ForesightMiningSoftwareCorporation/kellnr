...
export const GROUP_USERS = (group_name: string) =>
    `/api/v1/group/${group_name}/users`;
export const GROUP_USER = (group_name: string, name: string) =>
    `/api/v1/group/${group_name}/users/${name}`;

export const CRATE_USERS = (crate_name: string) =>
    `/api/v1/crate_access/${crate_name}/users`;
export const CRATE_USER = (crate_name: string, name: string) =>
    `/api/v1/crate_access/${crate_name}/users/${name}`;
export const CRATE_GROUPS = (crate_name: string) =>
    `/api/v1/crate_access/${crate_name}/groups`;
export const CRATE_GROUP = (crate_name: string, name: string) =>
    `/api/v1/crate_access/${crate_name}/groups/${name}`;
export const CRATE_ACCESS_DATA = (crate_name: string) =>
    `/api/v1/crate_access/${crate_name}/access_data`;
...
// External URL
export const CRATESIO_LINK = (name: string) =>
